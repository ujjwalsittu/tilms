                        ...
                        {data.type === 'individual' && (
                            <>
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.starter_code} onChange={(e) => setData('starter_code', e.target.value)} rows={8} fontFamily="mono" fontSize="sm" bg="gray.50" />
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.test_cases} onChange={(e) => setData('test_cases', e.target.value)} rows={6} fontFamily="mono" fontSize="sm" bg="gray.50" />
                        ...
                        {data.type === 'project' && (
                            <>
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.project_requirements} onChange={(e) => setData('project_requirements', e.target.value)} rows={10} />
