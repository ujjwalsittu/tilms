                                ...
                                <Box>
                                    ...
                                    <Textarea
                                        ...
                                        placeholder={JSON.stringify([
                                            { input: "hello", expected: "HELLO", description: "Uppercase conversion" }
                                        ], null, 2)}
                                        bg="gray.50"
                                    />
                                    <Text fontSize="xs" color="gray.500" mt={1}>
                                        JSON array of test cases: [{"{ input, expected, description }"}]
                                    </Text>
                            ...
                            <>
                                ...
                                <Box>
                                    ...
                                    <Textarea
                                        ...
                                        rows={10}
                                        placeholder="List detailed project requirements, acceptance criteria, deliverables, and submission instructions..."
                                    />
                                    <Text fontSize="xs" color="gray.500" mt={1}>
                                        Markdown supported. Students will submit a GitHub repository link.
                                    </Text>
