...
export default function Create() {
    ...
    return (
        <InstructorLayout title="Create Task">
                ...
                <Box as="form" onSubmit={handleSubmit} bg="white" p={8} borderRadius="lg" boxShadow="sm" borderWidth="1px">
                    <VStack gap={6} align="stretch">
                        ...
                        <Box>
                            ...
                            <Input value={data.title} onChange={(e) => setData('title', e.target.value)} placeholder="e.g. Build a REST API with Express" />
                        ...
                        <Box>
                            ...
                            <Textarea value={data.description} onChange={(e) => setData('description', e.target.value)} rows={5} placeholder="Describe the task requirements, objectives, and deliverables..." />
                        ...
                        <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                            <Box>
                                ...
                                <select value={data.type} onChange={(e) => setData('type', e.target.value)} style={sel}>
                            ...
                            <Box>
                                ...
                                <select value={data.difficulty} onChange={(e) => setData('difficulty', e.target.value)} style={sel}>
                        ...
                        <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                            <Box>
                                ...
                                <select value={data.programming_language} onChange={(e) => setData('programming_language', e.target.value)} style={sel}>
                            ...
                            <Box>
                                ...
                                <Input type="number" value={data.estimated_minutes} onChange={(e) => setData('estimated_minutes', Number(e.target.value))} min="1" />
                        ...
                        <Box>
                            ...
                            <Input value={data.tags} onChange={(e) => setData('tags', e.target.value)} placeholder="react, api, authentication (comma-separated)" />
                            <Text fontSize="xs" color="gray.500" mt={1}>Comma-separated tags for filtering</Text>
                            {errors.tags && <Text fontSize="sm" color="red.500" mt={1}>{errors.tags}</Text>}
                        </Box>

                        <Box borderBottomWidth="1px" borderColor="gray.200" my={4} />
                        ...
                        {data.type === 'individual' && (
                            <>
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.starter_code} onChange={(e) => setData('starter_code', e.target.value)} rows={8} fontFamily="mono" fontSize="sm" placeholder="// Provide starter code for students..." bg="gray.50" />
                                    <Text fontSize="xs" color="gray.500" mt={1}>Initial code scaffolding provided to students</Text>
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.test_cases} onChange={(e) => setData('test_cases', e.target.value)} rows={6} fontFamily="mono" fontSize="sm" placeholder='[{"input": "hello", "expected": "HELLO", "description": "Uppercase conversion"}]' bg="gray.50" />
                                    <Text fontSize="xs" color="gray.500" mt={1}>JSON array of test cases: [{'{input, expected, description}'}]</Text>
                        ...
                        {data.type === 'project' && (
                            <>
                                ...
                                <Box>
                                    ...
                                    <Textarea value={data.project_requirements} onChange={(e) => setData('project_requirements', e.target.value)} rows={10} placeholder="List detailed project requirements, acceptance criteria, deliverables, and submission instructions..." />
                                    <Text fontSize="xs" color="gray.500" mt={1}>Markdown supported. Students will submit a GitHub repository link.</Text>
                        ...
                        <HStack justify="flex-end" gap={3} pt={2}>
                            ...
                            <Button type="submit" colorPalette="blue" loading={processing} loadingText="Creating...">
                                Create Task
                            </Button>
                        </HStack>
                    </VStack>
