                    ...
                    <VStack gap={6} align="stretch">
                        ...
                        <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                            <Box>
                                ...
                                <Input type="number" value={data.price_amount} onChange={(e) => setData('price_amount', e.target.value)} placeholder="Leave blank for free" min="0" />
                            ...
                            <Box>
                                ...
                                <select value={data.price_currency} onChange={(e) => setData('price_currency', e.target.value)} style={sel}>
                        ...
                        <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                            <Box>
                                ...
                                <Input type="datetime-local" value={data.registration_opens_at} onChange={(e) => setData('registration_opens_at', e.target.value)} />
                        ...
                        <SimpleGrid columns={{ base: 1, md: 2 }} gap={4}>
                            <Box>
                                ...
                                <select value={data.task_ordering} onChange={(e) => setData('task_ordering', e.target.value)} style={sel}>
                            ...
                            <Box>
                                ...
                                <Input type="number" value={data.completion_threshold} onChange={(e) => setData('completion_threshold', Number(e.target.value))} min="0" max="100" />
                            ...
                            <Box>
                                ...
                                <Input type="number" value={data.max_students} onChange={(e) => setData('max_students', e.target.value)} placeholder="Leave blank for unlimited" min="1" />
                        ...
                        <VStack gap={3} align="start">
                            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', fontSize: '0.875rem' }}>
                                <input type="checkbox" checked={data.has_free_audit} onChange={(e) => setData('has_free_audit', e.target.checked)} />
                                Enable Free Audit
                            </label>
                            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', fontSize: '0.875rem' }}>
                                <input type="checkbox" checked={data.has_waitlist} onChange={(e) => setData('has_waitlist', e.target.checked)} />
                                Enable Waitlist
                            </label>
                            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', fontSize: '0.875rem' }}>
                                <input type="checkbox" checked={data.has_leaderboard} onChange={(e) => setData('has_leaderboard', e.target.checked)} />
                                Enable Leaderboard
                            </label>
                        </VStack>
                        ...
                        <HStack justify="flex-end" gap={3} pt={2}>
                            ...
                            <Button type="submit" colorPalette="blue" loading={processing} loadingText="Saving...">
                                Save Changes
                            </Button>
                        </HStack>
                    </VStack>
