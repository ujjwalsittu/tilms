...
export default function Create() {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('instructor.cohorts.store'));
    };

    return (
        <InstructorLayout title="Create Cohort">
            <Head title="Create Cohort" />
            <FlashMessage />

            <Box maxW="3xl" mx="auto">
                <Text fontSize="2xl" fontWeight="bold" mb={6}>Create New Cohort</Text>
                    ...
                    <VStack gap={6} align="stretch">
                        ...
                        <VStack gap={3} align="start">
                            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', fontSize: '0.875rem' }}>
                                ...
                                />
                                Enable Free Audit (students can view without paying)
                            </label>
                            <label style={{ display: 'flex', alignItems: 'center', gap: 8, cursor: 'pointer', fontSize: '0.875rem' }}>
                                <input
                                    type="checkbox"
